...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">添加投票信息:</div>
        <div class="panel-body">
            <form action="toupiaoxinxiinsert.do" method="post" name="form1" id="form1">
                <!-- form 标签开始 -->
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control class_fenlei14" data-value="" id="fenlei" name="fenlei" style="width: 250px">
