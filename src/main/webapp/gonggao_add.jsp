    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="gonggaoinsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入标题" style="width: 150px" id="biaoti" name="biaoti" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
