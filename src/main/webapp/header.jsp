        ...
        <div class="container">
            ...
            <div class="row" gutter="20">
                <div class="col-xs-12 col-sm-12 col-md-7 logo-holder">
                    <!-- ============================================================= LOGO ============================================================= -->
                    <div class="logo"><a href="./"> 问卷投票系统 </a></div>
                    <!-- /.logo -->
                    <!-- ============================================================= LOGO : END ============================================================= -->
                </div>
                <!-- /.logo-holder -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 top-search-holder">
                    ...
                    <div class="search-area">
                        <form method="get" action="toupiaoxinxilist.do">
                            <div class="control-group">
                                <input class="search-field" type="text" value="${param.mingcheng}" name="mingcheng" placeholder="输入关键词" />
        ...
        <div class="container">
            ...
            <div class="nav-list clearfix">
                <ul class="clearfix" id="navbar-str">
                    ...
                    <li>
                        <a href="toupiaoxinxilist.do">投票信息 </a>
                        <ul class="nav-child">
                            <ssm:sql var="mapfenlei1" type="select"> SELECT id,fenlei FROM fenlei </ssm:sql>
                            <c:forEach items="${mapfenlei1}" var="m"
                                ><c:set var="m" value="${m}" scope="request" />
                                <li><a href="toupiaoxinxilist.do?fenlei=${m.id}">${m.fenlei}</a></li>
                            </c:forEach>
                        </ul>
                    </li>
                    <li>
                        <a href="wenjuanlist.do">问卷信息 </a>
                    </li>
                    <li>
                        <a href="gonggaolist.do">公告信息 </a>
                    </li>
                    <li>
                        <a href="yonghuadd.do">用户注册 </a>
                    </li>
                    <li>
