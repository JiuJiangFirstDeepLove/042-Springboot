...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="module-name"> 问卷 </span>
            <span>列表</span>
        </div>
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td align="center">
                                    <a href="timu_add.do?id=${map.id}">题目</a>

                                    <a href="wenjuan_detail.do?id=${map.id}">详情</a>

                                    <a href="wenjuan_updt.do?id=${map.id}">编辑</a>

                                    <a href="wenjuan_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                    <!--qiatnalijne-->
                                </td>
                            </tr>
                        </c:forEach>
