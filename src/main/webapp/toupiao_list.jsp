            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei1" data-value="${param.fenlei}" id="fenlei" name="fenlei">
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>${map.bianhao}</td>
                                <td>${map.mingcheng}</td>
                                <td><ssm:sql var="mapfenlei1" type="find"> SELECT fenlei,id FROM fenlei where id='${map.fenlei}' </ssm:sql>${mapfenlei1.fenlei}</td>
                                <td>${map.zhuangtai}</td>
                                <td>${map.xingming}</td>
                                <td>${map.dianhua}</td>
                                <td>${map.beizhu}</td>
